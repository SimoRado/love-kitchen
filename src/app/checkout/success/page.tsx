...
function OrderSuccessContent() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF9] flex flex-col justify-center items-center px-4 py-12">
      <div className="max-w-md w-full bg-white rounded-3xl border border-[#EBE3D5] p-8 shadow-sm text-center">
        {/* Success Icon */}
        ...
        <p className="text-xs text-slate-500 mt-1.5 leading-relaxed">
          Your order <strong className="text-slate-900 font-bold">#{orderNumber}</strong> has been sent to the kitchen and is being prepared.
        </p>
        ...
        <div className="p-3 bg-orange-50/70 border border-orange-100 rounded-xl flex items-center gap-2.5 text-orange-950 text-xs mb-6 text-left">
          ...
          <span>Our chefs are preparing your meal fresh. Pay upon delivery/pickup.</span>
        </div>

        {/* Action Button */}
        <Link
          href="/"
          className="w-full inline-flex items-center justify-center gap-2 py-3.5 px-5 rounded-xl bg-primary hover:bg-primary-hover text-white text-xs font-bold shadow-xs transition-colors"
        >
